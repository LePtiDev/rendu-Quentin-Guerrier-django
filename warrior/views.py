...
def index(request):
    ...
    return render(request, 'warrior/index.html', {'items': items})
...
def create(request):
    ...
    if item_form_create.is_valid():
        ...
        return render(request, 'warrior/update.html', {'item': item_form_create})

    context["item"] = item_form_create
    return render(request, 'warrior/create.html', context)
...
def update(request, id):
    ...
    return render(request, 'warrior/update.html', context)
